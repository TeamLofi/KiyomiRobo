...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("𝗛𝗘𝗟𝗣", url="https://t.me/TeamLofi"),
          InlineKeyboardButton("𝗢𝗪𝗡𝗘𝗥", url="https://t.me/LofiUpdates"),
          ],
               [
                InlineKeyboardButton("𝗟𝗜𝗩𝗘 𝗖𝗖", url="https://t.me/TeamLofi"),
